            ...
            <>
              ...
              <ModalBody>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="网站名称" variant="bordered" placeholder="示例：龙氏" isInvalid={!!errors.title?.message} errorMessage={errors.title?.message} onBlur={() => trigger('title')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="图片地址" variant="bordered" placeholder="示例：https://long2025.top/logo.jpg" isInvalid={!!errors.image?.message} errorMessage={errors.image?.message} onBlur={() => trigger('image')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="网站地址" variant="bordered" placeholder="示例：https://long2025.top" isInvalid={!!errors.url?.message} errorMessage={errors.url?.message} onBlur={() => trigger('url')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="邮箱（选填）" variant="bordered" placeholder="示例：longsbt@er.long2024.cn" isInvalid={!!errors.email?.message} errorMessage={errors.email?.message} onBlur={() => trigger('email')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="订阅地址（选填）" variant="bordered" placeholder="示例：https://long2025.top/index.php/feed/" isInvalid={!!errors.rss?.message} errorMessage={errors.rss?.message} onBlur={() => trigger('rss')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
