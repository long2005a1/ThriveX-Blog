                ...
                render={({ field }) => (
                  <>
                    <Input
                      ...
                      label="图片地址"
                      variant="bordered"
                      placeholder="示例：https://*.long2025.top/xx.jpg"
                ...
                render={({ field }) => (
                  <>
                    <Input
                      ...
                      label="网站地址"
                      variant="bordered"
                      placeholder="示例：https://long2025.top/"
                ...
                render={({ field }) => (
                  <>
                    <Input
                      ...
                      label="邮箱（选填）"
                      variant="bordered"
                      placeholder="示例：longbt@er.long2024.cn"
                ...
                render={({ field }) => (
                  <>
                    <Input
                      ...
                      label="订阅地址（选填）"
                      variant="bordered"
                      placeholder="示例：https://long2025.top//api/rss"
